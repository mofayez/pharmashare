                        ...
                        $.each(response.data.drugs, function (index, item) {
                            ...
                            table.row.add([
                                ...
                                `<h6  class="m-0 p-0" style="text-align: left">
                                    ...
                                    <span>dir</span>
                                    <small class="btn-danger btn-simple p-1 mr-1 ml-1 ${item.FOC.length > 0 ? '' : 'd-none'}"  data-tooltip="${item.FOC.length > 0 ? ('when you buy amount: ' + item.FOC[0].foc_quantity + ' discount will be: ' + item.FOC[0].foc_discount) : '' }" style="font-size: 10px;top: 5px;position: relative;">   {{__('pharmacy.discount')}}    </small>
